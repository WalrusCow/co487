...
def main():
    ...
    best_key, bias = find_key(p_texts, c_texts, 'xxxx????xxxx????', relation_2ab)
    ...
    print('Question 2b: The best key guess is {} with bias {}'.format(best_key, bias))
    print('Question 2d: The final key bits are {} with bias {}'.format(total_key, end_bias))
